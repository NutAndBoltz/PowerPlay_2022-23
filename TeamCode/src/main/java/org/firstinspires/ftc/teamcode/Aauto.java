...
//        robot.closerL.setPosition(.25);
//    }
//    public void closeTheClaw(){
//        robot.closerL.setPosition(.5);
//    }
//
...
//
//        double inches = INCH_PER_DEGREE * degrees;
...
//
//        // Determine new target position, and pass to motor controller
//        newArmLiftTarget = robot.armLiftLeft.getCurrentPosition() + (int) (count);
//        robot.armLiftLeft.setTargetPosition(newArmLiftTarget);
//
//        // Turn On RUN_TO_POSITION
